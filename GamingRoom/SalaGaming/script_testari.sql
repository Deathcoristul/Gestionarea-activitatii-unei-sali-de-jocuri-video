...
--afisare sesiuni cu tipuri de joc si servicii streaming
SELECT id_sesiune,denumire_joc "Nume Joc",tp.id_tip "ID Tip",denumire_tip "Tipul Jocului",ss.id_serviciu,ss.nume "Nume Serviciu de Stream"
FROM sesiune_gaming sg,serviciu_streaming ss,tip_joc tp
WHERE sg.id_serviciu=ss.id_serviciu AND sg.id_tip=tp.id_tip;
--afisare achitari
...
--daca introducem un tip de joc fara denumire(e acelasi lucru si cu sesiune_gaming fara nume joc si serviciu_streaming fara denumire)
